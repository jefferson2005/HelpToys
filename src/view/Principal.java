...
public class Principal extends JFrame {
	...
	public Principal() {
				...
				try {
					...
					if (con == null) {
						...
						lblStatus.setIcon(new ImageIcon(
								Usuarios.class.getResource("/img/2124501_app_check_data_essential_ui_icon.png")));
					}
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(
				Principal.class.getResource("/img/993813_matreshka_matrioshka_mother_open_souvenir_icon.png")));
